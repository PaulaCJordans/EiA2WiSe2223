...
namespace a06_shoppinglist {
    ...
    async function handleload(): Promise<void> {
        ...
        let response: Response = await fetch("https://webuser.hs-furtwangen.de/~jordansp/Database/?command=find&collection=shopping");
    ...
    async function submitbutton(): Promise<void> {
        ...
        let response: Response = await fetch("https://webuser.hs-furtwangen.de/~jordansp/Database/?" + query.toString());
