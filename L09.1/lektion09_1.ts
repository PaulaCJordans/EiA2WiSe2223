...
namespace Farm {
    ...
    function loadAnimals(): void {
        let cow: Animal = new Animal("Susi", "cow", "greens", "moo", 10);
        let dog: Animal = new Animal("Schoko", "dog", "meat", "woof", 12);
        let cat: Animal = new Animal("Dexti", "cat", "fish", "miauz", 5);
        let chicken: Animal = new Animal("berta", "chicken", "corn", "bock", 30);
        let pig: Animal = new Animal("Peppa", "pig", "carrots", "quick", 25);
